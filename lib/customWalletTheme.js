export const customWalletTheme = {
  ...
  "--ck-connectbutton-color": "#00000",
  "--ck-connectbutton-background": "#6ee8be",
  ...
  "--ck-connectbutton-hover-color": "#fffdfd",
  "--ck-connectbutton-hover-background": "#fe4fed",
  ...
  "--ck-primary-button-hover-background": "#f4f4f4",
